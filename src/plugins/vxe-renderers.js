...
function compareByOperator(rawCellValue, rule, valueType) {
...
VXETable.renderer.add(FILTERS_COMPLEX_INPUT, {
    renderFilter(renderOpts, params) {
        return [h(FilterComplex, { params, renderOpts })];
    },

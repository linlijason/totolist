...
const Cell = exports.Cell = {
  ...
  renderEditHeader(params) {
    ...
    if ((0, _utils.isEnableConf)(editConfig)) {
      editIconVNs = [isRequired && editOpts.showAsterisk ? (0, _vue.h)('span', {
        class: 'vxe-cell--required-icon'
      }, [(0, _vue.h)('i')]) : renderEmptyElement($table), (0, _utils.isEnableConf)(editRender) && editOpts.showIcon ? (0, _vue.h)('span', {
